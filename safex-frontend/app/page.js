// File: app/page.js
// CORRECTED: This version adds the "View Profile" link to the header.
...
export default function DashboardPage() {
  ...
  const fetchData = async () => {
    // Disabled for frontend-only demo
  };
          ...
          <div className="max-w-7xl mx-auto pt-24">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                <StatCard title="Heart Rate" value={null} unit="bpm" icon="❤️" color="text-red-400" trend="stable" />
                <StatCard title="SpO₂" value={null} unit="%" icon="💨" color="text-sky-400" trend="stable" />
                <StatCard title="CO Level" value={null} unit="ppm" icon="🔥" color="text-amber-400" trend="stable"/>
                <StatCard title="LPG Level" value={null} unit="ppm" icon="🏭" color="text-slate-400" trend="stable" />
              </div>
              <div className="space-y-6">
                <DeviceStatus deviceId={null} lastUpdate={lastUpdate} isOnline={true}/>
                <AlertPanel />
              </div>
            </div>
          </div>
